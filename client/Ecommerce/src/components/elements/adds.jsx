function Review(){
    return (
        <>
        <div>
 <section aria-labelledby="testimonial-heading" class="relative mx-auto max-w-7xl px-20 py-10">
    <div class="mx-auto max-w-2xl lg:max-w-none">
      ...
      <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
        ...
        <blockquote class="sm:flex lg:block">
          ...
          <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
            <p class="text-lg text-gray-600">Now that I’m on holiday for the summer, I’ll probably order a few more shirts. It’s just so convenient.</p>
